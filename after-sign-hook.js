 ...
 *
 * @private
 * @description event handler when code signing is done
...
exports.default = async context => {
  ...
  const message = `[AFTER SIGN HOOK] ENV=${env} PROCESS_ENV=${process.env.NODE_ENV} APP_NAME=${context.packager.appInfo.productFilename} APP_OUT_DIR=${context.appOutDir} PLATFORM=${context.packager.platform.name} ELECTRON_PLATFORM_NAME=${context.electronPlatformName}`;
